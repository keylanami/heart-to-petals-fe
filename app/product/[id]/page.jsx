      ...
      if (savedReviews) {
        ...
        setReviews([
          ...
          },
          {
            ...
            name: "Budi Santoso",
            rating: 4,
            text: "Pengiriman cepat, tapi packing agak penyok dikit.",
            date: "10 Okt 2025",
          },
        ]);
      }
    ...
    return (
      <main className="bg-cream-bg min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            onClick={() => router.back()}
            className="text-sage-green underline"
          >
            Kembali ke Shop
          </button>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start">
            ...
            >
              ...
              <div className="absolute top-6 left-6">
                <span
                  className={`px-4 py-2 rounded-full text-xs font-bold uppercase tracking-widest backdrop-blur-md shadow-sm text-white ${
                    product.theme === "dark"
                      ? "bg-dark-green/80"
                      : "bg-sage-green/90"
                  }`}
            ...
            <div className="flex flex-col h-full pt-2">
              ...
              <p className="text-2xl font-sans font-medium text-gray-800 mb-6">
                {priceFormatted}
              </p>
                  ...
                  {["story", "flowers", "care", "reviews"].map((tab) => (
                    ...
                    >
                      ...
                      {activeTab === tab && (
                        <motion.div
                          layoutId="underline"
                          className="absolute bottom-0 left-0 w-full h-[2px] bg-dark-green"
                        />
                      )}
                    </button>
                  ))}
                  ...
                  <AnimatePresence mode="wait">
                    {activeTab === "story" && (
                      ...
                      >
                        <BookOpen
                          size={18}
                          className="text-sage-green shrink-0 mt-0.5"
                        />
                        <p className="leading-relaxed italic">
                          "{product.story || product.desc}"
                        </p>
                      </motion.div>
                    )}
                    ...
                    {activeTab === "care" && (
                      ...
                      >
                        ...
                        <p className="leading-relaxed">
                          {product.care ||
                            "Ganti air setiap hari dan potong batang."}
                        </p>
                      </motion.div>
                    )}
                    ...
                    {activeTab === "reviews" && (
                      ...
                      >
                        ...
                        >
                          ...
                          <button
                            type="submit"
                            className="w-full bg-dark-green text-white py-2 rounded-lg text-xs font-bold uppercase tracking-wider hover:bg-sage-green transition"
                          >
                            Kirim Ulasan
                          </button>
                        </form>
                        ...
                        <div className="space-y-4 max-h-60 overflow-y-auto custom-scrollbar pr-2">
                          {reviews.length === 0 ? (
                            <p className="text-center text-gray-400 italic text-xs py-4">
                              ...
                              >
                                <div className="flex justify-between items-start mb-1">
                                  <div className="flex items-center gap-2">
                                    ...
                                    <span className="font-bold text-dark-green text-xs">
                                      {rev.name}
                                    </span>
                                  </div>
              ...
              <div className="mt-auto pt-6 border-t border-gray-100 flex gap-4">
                <div className="flex items-center gap-4 bg-gray-50 rounded-full px-4 py-3 border border-gray-200">
                  <button
                    ...
                    className="hover:text-dark-green transition"
                  >
                    <Minus size={16} />
                  </button>
                ...
                <button
                  ...
                  className="flex-1 bg-dark-green text-white rounded-full font-bold uppercase tracking-wide hover:bg-sage-green transition-colors shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                >
                  <ShoppingBag size={18} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {relatedProducts.map((item) => (
              <Link
                ...
                key={item.id}
                className="group block bg-white rounded-2xl p-4 shadow-sm hover:shadow-xl transition-all border border-transparent hover:border-sage-green/30"
              >

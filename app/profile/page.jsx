...
import { 
    User, MapPin, Lock, LogOut, Save, Camera, ChevronRight 
} from "lucide-react";
        ...
        <div className="flex flex-col md:flex-row items-center gap-6 mb-12">
            ...
            <div className="text-center md:text-left">
                ...
                <div className="flex items-center justify-center md:justify-start gap-2 mt-2">
                    <span className="bg-sage-green/10 text-sage-green px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">Member</span>
                </div>
            </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-3">
                ...
                >
                    ...
                    {activeTab === "personal" && (
                        <form onSubmit={handleSave} className="space-y-6">
                            ...
                            <div className="pt-6 flex justify-end">
                                <button type="submit" disabled={isLoading} className="bg-dark-green text-white px-8 py-3 rounded-full font-bold flex items-center gap-2 hover:bg-sage-green transition-all shadow-lg active:scale-95 disabled:opacity-50">
                    ...
                    {activeTab === "address" && (
                        <form onSubmit={handleSave} className="space-y-6">
                            <h2 className="text-xl font-bold text-dark-green mb-6 border-b border-gray-100 pb-4">Atur Alamat</h2>
                                ...
                                <div className="flex gap-3">
                                    {["Rumah", "Kantor", "Apartemen"].map(l => (
                                        <button 
                                            ...
                                            className={`px-4 py-2 rounded-lg text-xs font-bold border transition-all ${formData.label === l ? "bg-sage-green text-white border-sage-green" : "bg-white text-gray-500 border-gray-200 hover:border-sage-green"}`}
                                        >
                                            {l}
                                        </button>
                                    ))}
                            ...
                            <div className="pt-6 flex justify-end">
                                <button type="submit" disabled={isLoading} className="bg-dark-green text-white px-8 py-3 rounded-full font-bold flex items-center gap-2 hover:bg-sage-green transition-all shadow-lg active:scale-95 disabled:opacity-50">
                                    {isLoading ? "Menyimpan..." : <><Save size={18} /> Update Alamat</>}
                                </button>
                            </div>
                        </form>
                    )}
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <input type="password" placeholder="••••••••" className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-sage-green transition-all" />
                                </div>
                                <div className="space-y-2">

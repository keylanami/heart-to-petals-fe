      ...
      <div className="max-w-xl mx-auto px-6 pt-32 pb-20">
        ...
        >
            ...
            <div className="pt-14 pb-8 px-8">
                <h1 className="text-2xl font-serif font-bold text-dark-green mb-2">Pesanan Berhasil Dibuat!</h1>
                <p className="text-gray-500 text-sm mb-6">Terima kasih telah berbelanja di HeartToPetals.</p>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-xl p-5 mb-6 text-left">
                    <div className="flex justify-between items-center mb-4 border-b border-gray-200 pb-3">
                        ...
                        <span className="text-sm font-bold text-dark-green">#{orderId}</span>
                    </div>
                    ...
                    <div className="mt-4">
                        <p className="text-xs text-gray-500 mb-2">BCA Virtual Account</p>
                        <div className="flex items-center gap-2 bg-white border border-gray-200 p-3 rounded-lg shadow-sm">
                            ...
                            <span className="flex-1 font-mono font-bold text-lg text-gray-800 tracking-wider">{vaNumber}</span>
                            <button 
                                onClick={handleCopy}
                ...
                <p className="text-xs text-gray-400 mb-8 leading-relaxed">
                    Pesanan akan otomatis diproses oleh Vendor setelah pembayaran terverifikasi. Cek email kamu untuk detail lengkap.
                </p>

                <div className="space-y-3">
                    <button className="w-full py-3 bg-dark-green text-white rounded-full font-bold shadow-md hover:bg-sage-green transition">
                        Cek Status Pesanan
                    </button>
        ...
        <div className="text-center mt-8 text-gray-400 text-xs">
            <p>Butuh bantuan? <a href="#" className="underline hover:text-dark-green">Hubungi CS kami</a></p>
        </div>

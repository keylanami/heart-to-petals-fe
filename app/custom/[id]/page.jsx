...
export default function CustomBuilder() {
  ...
  useEffect(() => {
    if (params?.id) {
      ...
      if (editId) {
        ...
        // Hapus ID agar kalau refresh tidak stuck di mode edit (opsional)
        localStorage.removeItem("editDraftId");
      }
    }
  }, [params, router, showToast]);

  // --- 2. LOGIC PACKAGING & CANVAS ---
  ...
  // Tampilkan Packaging (Untuk demo, kita tampilkan semua tanpa filter ketat agar tidak kosong)
  ...
  const handleSave = async (isCheckout = false) => {
    ...
    const payload = {
      ...
      previewImage: designImage, // Thumbnail
